var Gifffer = function() {
    ...
    var createContainer = function(w, h, el) {
        ...
        con[sa]('style', 'position:relative;cursor:pointer;width:' + w + 'px;max-width:100%;');
        // creating play button
        var play = d.createElement('DIV');
        play[sa]('class','gifffer-play-button');
        play[sa]('style', 'width:60px;height:60px;border-radius:30px;background:rgba(0, 0, 0, 0.3);position:absolute;left: calc(50% - 30px);top: calc(50% - 40px);');
